...
{
    /// <summary>
    /// Фабрика, порождающая экземпляры класса регистрации с жизненным циклом "singleton".
    /// </summary>
    public class SingletonLifestyle : Lifestyle
    {
        ...
        internal override Registration CreateRegistration(Type concreteType, Container container)
        {
            ...
            return new SingletonRegistration(concreteType, container);
        }
        ...
        internal override Registration CreateRegistration(Func<object> createInstanceCallback, Container container)
        {
            ...
            return new SingletonRegistration(createInstanceCallback, container);
        }
    }
}